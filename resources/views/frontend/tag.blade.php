...
@section('normal')
    ...
    <div class="body-middle">
        <div class="left-group">
            <div class="content">
                <div class="steps">
                    <a href="{{url('/')}}" title="Trang chủ">trang chủ</a> - <a href="{{url('tu-khoa', $tag->slug)}}" title="Chuyên mục">{{$tag->title}}</a>
                </div>
                <div class="list-news">
                    <div class="news">
            ...
            <div class="btn-group-like-share">
                <div class="btn-like-share-fb">
                    <div class='fb-like' data-action='like' data-href='{{url('tu-khoa', $tag->slug)}}' data-layout='button_count' data-share='true' data-show-faces='false' data-width='520'></div>

                </div>
                <div class="btn-like-gg">
                    <div class="g-plusone" data-size="standard" data-href="{{url('tu-khoa', $tag->slug)}}"></div>
                </div>
            </div>
            ...
            <div class="comment-bottom">
                <div class="fb-comments" data-href="{{url('tu-khoa', $tag->slug)}}" data-width="100%" data-numposts="5" data-mobile="1"></div>
            </div>
        </div>
