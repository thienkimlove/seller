                    ...
                    <div class="table-responsive">
                        <table class="table table-striped table-bordered table-hover">
                            ...
                            <tr>
                                ...
                                <th>Mã sản phẩm</th>
                                <th>Giá sản phẩm</th>
                                <th>Thuộc Dược liệu</th>
                                <th>Thuộc Bệnh</th>
                                <th>Thuộc Dạng bào chế</th>
                                <th>Tình trạng</th>
                                <th>Hành động</th>
                            ...
                            @foreach($contents as $content)
                                <tr>
                                    ...
                                    <td>{{$content->price}} {{$content->product_currency}}</td>
                                    <td>{{$content->medicine->title}}</td>
                                    <td>{{$content->disease->title}}</td>
                                    <td>{{(isset($content->delivery)) ? $content->delivery->title : 'None'}}</td>
                                    <td>{{ ($content->available) ? 'Còn' : 'Hết' }}</td>
                                    <td>
