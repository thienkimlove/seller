...
@section('content')
    <div class="row">
        <div class="col-lg-12">
            <h1 class="page-header">Bài tin tức</h1>
        </div>
    ...
    <div class="row">
        <div class="col-lg-12">
            ...
            <div class="form-group">
                {!! Form::label('title', 'Tên bài') !!}
                {!! Form::text('title', null, ['class' => 'form-control']) !!}
            </div>

            <div class="form-group">
                {!! Form::label('seo_title', 'Tên bài (SEO)') !!}
            ...
            <div class="form-group">
                ...
                {!! Form::select('category_id', \App\Site::getNoChildCategories(), null, ['class' => 'form-control']) !!}
            </div>
